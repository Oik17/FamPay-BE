...
func FetchAndStoreVideos(query string, videos *[]fiber.Map) error {
	for i := 0; i < 2; i++ { //Value limited to 2 to not exhaust api credits. Can run indefinitely asynchronously by replacing this line with just "for{"
